<main class="bg-gray-50 dark:bg-gray-900">
	...
	>
		<div class="block md:max-w-lg">
			<img src="/images/404.svg" alt="Error 500" />
		</div>
		<div class="text-center xl:max-w-4xl">
			<h1
				class="mb-3 text-2xl font-bold leading-tight text-gray-900 dark:text-white sm:text-4xl lg:text-5xl"
			>
				Что-то серьезно пошло не так
			</h1>
			<p class="mb-5 text-center text-base font-normal text-gray-500 dark:text-gray-400 md:text-lg">
				Всегда можно сделать перерыв на кофе. Мы исправим ошибку к тому времени когда вы его
				допьёте.
			</p>
